...
# Only these three formats — used to isolate/verify the pandoc (md/html)
# and libreoffice (pptx) conversion paths after installing the new tools.
FORMAT_FOLDERS = ["md", "html", "pptx"]
